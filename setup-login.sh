...
{ oc get project ${OPENSHIFT_PRIMARY_PROJECT} 2>&1 >/dev/null && oc project ${OPENSHIFT_PRIMARY_PROJECT}; } || oc new-project ${OPENSHIFT_PRIMARY_PROJECT} || { echo "FAILED: Could not use indicated project" && exit 1; }
echo "Done."
