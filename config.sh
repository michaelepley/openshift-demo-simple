...
# select and configure for a particular openshift cluster
DEMO_TARGET_OPENSHIFT_INSTANCES=(local rhsademo)
DEMO_TARGET_OPENSHIFT_INSTANCE=rhsademo
...
# default openshift user configuration
...
OPENSHIFT_USER_RHSADEMO_MEPLEY=(mepley ${OPENSHIFT_USER_PRIMARY_PASSWORD_DEFAULT} mepley-myphp)
OPENSHIFT_USER_RHSADEMO_MEPLEY2=(mepley2 ${OPENSHIFT_USER_PRIMARY_PASSWORD_DEFAULT} mepley2-myphp)
